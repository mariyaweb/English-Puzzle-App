...
export const h1 = (params?: ElementParams, ...children: BaseElement[]) =>
  new BaseElement<HTMLElementTagNameMap['h1']>({ tag: 'h1', styles: ['h1'], ...params }, ...children);

export const h2 = (params?: ElementParams, ...children: BaseElement[]) =>
  new BaseElement<HTMLElementTagNameMap['h2']>({ tag: 'h2', styles: ['h2'], ...params }, ...children);

export const h3 = (params?: ElementParams, ...children: BaseElement[]) =>
  new BaseElement<HTMLElementTagNameMap['h3']>({ tag: 'h3', styles: ['h3'], ...params }, ...children);
export const h4 = (params?: ElementParams, ...children: BaseElement[]) =>
  new BaseElement<HTMLElementTagNameMap['h4']>({ tag: 'h4', styles: ['h4'], ...params }, ...children);

export const p = (params?: ElementParams, ...children: BaseElement[]) =>
  new BaseElement<HTMLElementTagNameMap['p']>({ tag: 'p', styles: ['p'], ...params }, ...children);
...
export const button = (params?: ElementParams, ...children: BaseElement[]) =>
  new BaseElement({ tag: 'button', styles: ['button'], ...params }, ...children);
